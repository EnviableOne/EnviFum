function Import-ModuleExchange{
 ...
 Param (
  ...
  [string]$ModulePath = "$($env:APPDATA)\Microsoft\Exchange\RemotePowerShell",
  [switch]$Silent
 )
.
 ...
 # By default we assume to not have a local installation of ExchangeShell
 $IsLocal = $false
