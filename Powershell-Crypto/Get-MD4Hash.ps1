...
.EXAMPLE
    Get-MD4Hash -Input "YourPassword1!"
    Get-MD4Hash Password1

 
.PARAMETER Input
    A String that represents the data that you want to hash.
 
.INPUTS
    A String containing the data you wish to hash.
...
.NOTES
    ...
    Updated: Peter Marquis, 2019, One@enviable.co.uk
...
'@
        ...
        [Byte[]]$DataToHash = [System.Text.Encoding]::Unicode.GetBytes($Input)
